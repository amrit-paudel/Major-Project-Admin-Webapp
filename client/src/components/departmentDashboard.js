  ...
  return (
    <div className="d-flex justify-content-center align-items-center" style={{height: 'calc(100vh - 56px)'}}>
      <div className="container">
        <div className="row">
          {['AddDepartment', 'ViewDepartments', 'EditDepartment', 'DeleteDepartment'].map((item, index) => (
            <div key={index} className="col-sm-6 col-md-3 mb-4" onClick={() => handleCardClick(item)}>
              <div className={`card text-white bg-${['primary', 'secondary', 'success', 'danger'][index % 4]} h-100`} style={{maxWidth: "18rem", cursor: 'pointer'}}>
